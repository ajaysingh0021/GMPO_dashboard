...
set url="http://hostname-win10.GMPO.com/GMPO/reports/02.GMPO_4.0_GA/20200615074304_4.0-GA-develop-1146-Legacy/allure-report/index.html"
echo %url%
set exec_flag="aks002Compare"

REM set build_name="LA-FCS"
set build_name="GA-1146"
