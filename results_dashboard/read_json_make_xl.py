...
if download_json:
    ...
    #     my_file.write(r.text)
    print("Downloaded json file: %s" % local_json_file)
    time.sleep(4)
else:
    print('Using existing json file: %s' % local_json_file)
...
print("Writing to csv file: %s" % excel_to_write)
...
xprint("Suite, Main-Scenario, Sub-Scenario, Test, Parameter, Status")
...
print("Data written to csv file: %s" % excel_to_write)
