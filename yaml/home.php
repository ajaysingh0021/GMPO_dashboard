...
<div id="leftdiv" style="float:left; width:75%; height:100%;">
    ...
    <tr>
		<td>
			<b>No. of Unmonitored Tunnels:</b><br>
			<font size="1"><i>If you want to create UNMONITORED tunnels in your suite/testcases, specify the count of tunnels required. <br>(Default: 0)</i></font>
		</td>
		<td>
                <input type="text" name="home_utnls">
		</td>
	</tr>
...
<div id="rightdiv" style="float:right; width:25%; height:90%; background-color:#FEF9E7; border-radius: 25px;">
    <br>
    <h4>&nbsp;The YAML Creator supports:</h4>
    <ul><font size="2">
    <li> Setup with minimum 2 Nodes & 1 Tgen</li>
    <li> Setup with JDSU SFP ports</li>
    <li> Setup with JDSU Deep-Analysis ports</li>
    <li> Execution requiring Unmonitored Tunnels </li></font>
    </ul>
    <h4>&nbsp;Use below links for special setups:</h4>
    <ul><font size="2">
    <li> <a href="../sbtyaml/home.php" target="_blank"> SBT Setup - with 1 node snake topology </a></li>
