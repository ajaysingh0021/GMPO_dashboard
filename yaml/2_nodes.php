...
<?php
    ...
    else if (intval(trim($_POST['home_nodes'])) < 2) {
    ...
    if ($errors) {
        ...
        if (($_POST['browser_type'] == 'Chrome')) {
            ...
            //print('<p><font size="2"><i>On IE/Firefox/Safari browsers, use browser back button to return to previous screen.</i></font></p>');
        }
        else {
